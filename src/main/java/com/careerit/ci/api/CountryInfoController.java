...
public class CountryInfoController {
    ...
    @GetMapping("/regionstats/{region}")
    public ResponseEntity<List<RegionStatsDto>> getRegionStats(@PathVariable("region") String region){
        return ResponseEntity.ok(countryInfoService.getRegionStats(region));
    }
